function module_params = read_module_params_forsite(channel)
    ...
    buffers = conn.fetch(1119305120,1119305121, {str});
    ...
    %system(['ezcaread -n ' strrep(channel, '_IN1', '_LIMIT')]);
        ...
        module_params.INPUT_SW = str2num(key(11));
        module_params.OFFSET_SW =  str2num(key(12));
        module_params.FILTERS_SW =  str2num(key(1:10));
        module_params.LIMIT_SW = str2num(key(14));
        module_params.DECIMATION_SW = str2num(key(16));
        module_params.OUTPUT_SW = str2num(key(13));
